...
class CashPaymentTest(unittest.TestCase):
    def test_constructor(self):
        ...
        self.assertEqual(cash.get_cash(), 1500.00)
        self.assertEqual(cash.get_cash_owner(), "First LastName")

        cash.withdraw(200)
        self.assertEqual(cash.get_cash(), 1300.00)
        ...
        self.assertEqual(cash.get_cash(), 2800.00)

        cash = CashPayment(
            1399.00
        )
        self.assertEqual(cash.get_cash(), 1399.00)
